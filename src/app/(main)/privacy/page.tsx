      ...
      <div className="overflow-hidden py-20 sm:py-32 lg:pb-32 xl:pb-36">
        <div className="flex flex-col justify-center items-center max-w-md mx-auto">
          ...
          <p className="mt-4 text-stone-300 text-justify">
            ...
            <a href="https://help.ko-fi.com/hc/en-us/articles/12284014348189-What-personal-information-is-shared-on-Ko-fi-as-supporter#what-personal-information-is-shared-on-ko-fi-as-supporter--0-0">
              this page
            </a>{" "}
            for specifics on their handling of personal information, as well as
            their <a href="https://more.ko-fi.com/privacy">privacy policy</a>.
          </p>
        </div>
      </div>
    </Container>
