...
const variantStyles = {
  solid: {
    ...
    gray: 'bg-gray-800 text-stone-100 hover:bg-gray-900 active:bg-gray-800 active:text-stone-100/80',
  },
  outline: {
    gray: 'border-gray-300 text-stone-300 hover:border-gray-400 active:bg-amber-600/25 active:text-stone-300/80',
  },
};
